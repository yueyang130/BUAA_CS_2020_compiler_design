#ifndef OPT_MIPS_GENERATOR_H_
#define OPT_MIPS_GENERATOR_H_
...
namespace OptMips {
	...
	static const unsigned int GP_ADDR = 0x10008000;
	static const unsigned int DATA_ADDR = 0x10010000;
